...
extern void vexpu2(int64_t n, const double* __restrict__ xvec, double* __restrict__ yvec) ;
extern void vexp_varloop(int64_t n, const double* __restrict__ xvec, double* __restrict__ yvec) ;
